                    ...
                    <Col>
                        <Form className="mt-md-5 ps-md-5">
                            <Form.Group as={Row} className="mb-md-4 mb-3" controlId="formPlaintextInstitution">
                                ...
                                <Col sm="8">
                                <Form.Control className="red" name="linkedin" type="text" placeholder="Institution" />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-md-4 mb-3" controlId="formPlaintextTitle">
                                ...
                                <Col sm="8">
                                <Form.Control className="red" name="github" type="text" placeholder="Certificate title" />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-3" controlId="formPlaintextTwitter">
                                ...
                                <Col sm="8">
                                <Form.Control className="red" type="text" placeholder="Certificate URL" />
                                </Col>
                            </Form.Group>
